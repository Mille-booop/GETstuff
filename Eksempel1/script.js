const noLayout=document.getElementById("noLayout");
const verticalLayout=document.getElementById("verticalLayout");
const horisontalLayout=document.getElementById("horisontalLayout");
const gridLayout=document.getElementById("gridLayout");

function noLayout() {
    console.log("Ingen layout valgt");
    document.getElementById('card').classList.remove('vertical', 'horisontal', 'grid');
}
function verticalLayout() {
    noLayout();
    document.getElementById('card').classList.add('vertical');
}
function horisontalLayout() {
    noLayout();
    document.getElementById('card').classList.add('horisontal')
}
function gridLayout() {
    noLayout();
...
function showTools() {
    ...
    document.getElementById('cardTools').innerHTML = /*HTML*/`
        ...
        <ul>
            ...
            <li>Nettleseren <a href="https://www.google.no/">Google Chrome</a></li>
        </ul>
    </div>
    `;
}
...
function showCSS() {
    ...
    document.getElementById('cardCSS').innerHTML = /*HTML*/`
        ...
        <ul>
            ...
            <li><a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/" target="_new">
                    Flexbox</a></li>
            <li><a href="https://css-tricks.com/snippets/css/complete-guide-grid/" target="_new">
                    Grid</a></li>
            <li><a href="https://www.w3schools.com/css/default.asp" target="_new">
                    W3Schools CSS Tutorial</a></li>
            <li><a href="https://www.w3schools.com/cssref/default.asp" target="_new">
                    W3Schools CSS Reference</a></li>
        </ul>
    </div>
    `;
}
function showJavaScript() {
    ...
    document.getElementById('cardJavaScript').innerHTML = /*HTML*/`
        ...
        Vi skal lære grunnleggende programmering ved å manipulere HTML-
        og CSS-kode på en nettside ved hjelp av JavaScript.
        <ul>
            <li><tt>background-color</tt></li>
            <li><tt>color</tt></li>
            <li><tt>padding</tt></li>
            ...
            <li>Det finnes en W3Schools JavaScript Tutorial,
                men her anbefaler vi <br />heller å følge kurset vårt på Moodle.</li>
